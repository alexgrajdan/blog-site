...
Setup git on how it should handle end of lines:
- If you run git directly on Windows:
```bash
git config --global core.autocrlf true
```
- If you run git on Unix/Linux (including WSL - applicable for this tutorial):
```bash
